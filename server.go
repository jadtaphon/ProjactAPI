...
func main() {
	...
	e.GET("/", func(c echo.Context) error {
		return c.HTML(http.StatusOK, "<div style='text-align: center; font-size: 3em;'><h1>หมดเวลา สแกน</h1></div>")
	})
	e.GET("/success", func(c echo.Context) error {
		return c.HTML(http.StatusOK, "<div style='text-align: center; font-size: 3em;'><h1>เช็คชื่อสำเร็จ</h1></div>")
	})
